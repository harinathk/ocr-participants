package com.medileads.spring.cloud.ocr.participants;
...
public class OcrParticipantsApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		participants.add(new Participant("Dr.Venkat", "K", "MA", "S", Arrays.asList("123", "456")));
		participants.add(new Participant("Dr.Ramakrishna", "D", "MA", "S", Arrays.asList("456")));		
	}
